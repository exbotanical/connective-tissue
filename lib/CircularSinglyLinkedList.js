...
export class CircularSinglyLinkedList {
	 ...
	 * @throws {TypeError} Throws if provided a list that is not an instance of `CircularSinglyLinkedList`
	 */
	pushBackList (other) {
		if (!other) return;
		if (!(other instanceof CircularSinglyLinkedList)) throw new TypeError('other must be an instance of `CircularSinglyLinkedList`');
